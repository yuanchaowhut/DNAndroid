...
import cn.com.egova.dnrouter.parcelable.TestParcelable;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            DNRouter.init(getApplication());  //init之后，rootMap表就有了
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void module2Jump(View view) {
        DNRouter.getInstance().build("/module2/test").withString("msg", "从MainActivity").navigation();
    }
