package cn.com.egova.compiler.utils;
...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get("cn.com.egova.router.core", "DNRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "cn.com.egova.annotation.Route";
    public static final String ANN_TYPE_Extra = "cn.com.egova.annotation.Extra";


    public static final String IROUTE_GROUP = "cn.com.egova.router.core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "cn.com.egova.router.core.template.IRouteRoot";
    public static final String IEXTRA = "cn.com.egova.router.core.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "cn.com.egova.router.core.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "cn.com.egova.router.routes";
