...
public class SkinResources {
    ...
    private Resources mAppResources;   //当前应用的Resources类.
    private Resources mSkinResources;  //皮肤APK的Resources类.
    private String mSkinPkgName;   //皮肤APK的包名
    private boolean isDefaultSkin = true;  //是否应用默认的皮肤
    ...
    public void applySkin(Resources resources, String pkgName) {
        ...
        //是否使用默认皮肤.
        isDefaultSkin = TextUtils.isEmpty(pkgName) ? true : false;
    }
